        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2021, 7, 28, 6, 13, 54, 179, DateTimeKind.Local).AddTicks(6026)),
                    ...
                    ShipPhoneNumber = table.Column<string>(unicode: false, maxLength: 20, nullable: false),
                    Status = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaguageId = table.Column<string>(unicode: false, maxLength: 5, nullable: false),
